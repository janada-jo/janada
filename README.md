...
VITE_SCRIPT_URL=https://script.google.com/macros/s/AKfycbzs3a5jL08k_gcs2Jfc6Fx9p6Xlphv2ejQbgnaeS_duCOl9yYJrIYSZerIMMam5CULt/exec
```
...
أعمدة الورقة (`Sheet1`) بالترتيب:

| A | B | C | D | E | F | G | H | I | J | K | L | M |
|---|---|----|----|----|----|----|----|----|----|----|----|----|
| ID | تاريخ التسجيل | الاسم الرباعي | الرقم الوطني | تاريخ الميلاد | الحالة الاجتماعية | المؤهل العلمي | التخصص | طبيعة العمل | مكان السكن | رقم الهاتف | نوع الدم | مشترك بالجمعية |
